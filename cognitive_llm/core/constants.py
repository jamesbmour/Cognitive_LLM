...
OPENROUTER_DEFAULT_CHAT_MODEL = "nousresearch/nous-capybara-7b:free"
OPENROUTER_DEFAULT_INSTRUCT_MODEL = "nousresearch/nous-capybara-7b:free"
# Default embedding model
# DEFAULT_EMBEDDING_MODEL = "text-embedding-3-small"
DEFAULT_EMBEDDING_MODEL = "huggingface_instruct"
EMBEDDING_MODELS = ['text-embedding-3-small', 'text-embedding-3-large', 'huggingface_instruct']

LLM_MODELS = ['nousresearch/nous-capybara-7b:free', 'mistralai/mistral-7b-instruct:free', 'gryphe/mythomist-7b:free','gryphe/mythomist-7b:free' ]
