...
from cognitive_llm.core.debug import FakeVectorStore, FakeEmbeddings
...
#
# def embed_files(files: List, embedding: str, vector_store: str, **kwargs) -> FolderIndex:
#     """Embeds a collection of files and stores them in a FolderIndex."""
#     supported_embeddings = {
#         "openai": OpenAIEmbeddings,
#         # Add other supported embeddings here...
#     }
#     supported_vector_stores = {
#         "faiss": FAISS,
#         # Add other supported vector stores here...
#     }
#
#     if embedding in supported_embeddings:
#         _embeddings = supported_embeddings[embedding](**kwargs)  # Pass kwargs directly
#     else:
#         raise NotImplementedError(f"Embedding {embedding} not supported.")
#
#     if vector_store in supported_vector_stores:
